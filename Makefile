...
include dotfiles/podman/Makefile
...
include hosts/maxwell/Makefile
include hosts/newton/Makefile

upgrade: ## Upgrade the system
	rpm-ostree upgrade
	flatpak update -y
	if command -v paru > /dev/null; then paru -Syu --noconfirm; else distrobox enter wezterm -- paru -Syu --noconfirm; fi
	systemctl reboot
