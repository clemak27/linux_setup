...
" installed plugins:
Plugin 'joshdick/onedark.vim' " atom one dark theme
Plugin 'bling/vim-airline' " better looking tab/statusline
...
Plugin 'townk/vim-autoclose' " autocomplete ({[, etc
Plugin 'tpope/vim-surround' " brackets around words ysiw(
