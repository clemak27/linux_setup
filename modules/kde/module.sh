...
__kde_config() {
  ...
  kwriteconfig6 --file "$config_dir/kdeglobals" --group "KFileDialog Settings" --key "Sort hidden files last" "false"
  ...
  kwriteconfig6 --file "$config_dir/kdeglobals" --group "KFileDialog Settings" --key "View Style" "DetailTree"
