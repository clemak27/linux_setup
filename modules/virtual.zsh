...
pacman -S --quiet --noprogressbar --noconfirm qemu virt-manager virt-viewer dnsmasq vde2 bridge-utils openbsd-netcat ovmf
pacman -S --quiet --noprogressbar --noconfirm ebtables iptables
