...
# zsh
ln -sf $dotfile_dir/zshrc $user_dir/.zshrc
ln -sf $dotfile_dir/glab.zsh $user_dir/.glab.zsh
ln -sf $dotfile_dir/curl.zsh $user_dir/.curl.zsh
ln -sf $dotfile_dir/starship.toml $user_dir/.starship.toml

# delta
ln -sf $dotfile_dir/delta.config $user_dir/.delta.config
...
# intelliJ
ln -sf $dotfile_dir/ideavimrc $user_dir/.ideavimrc
...
ln -sf $dotfile_dir/todo/todo.cfg $user_dir/.todo/config
