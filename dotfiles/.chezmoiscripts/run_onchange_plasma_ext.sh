...
elif [ -d "$HOME/.local/share/plasma/plasmoids/luisbocanegra.panel.colorizer" ]; then
  kpackagetool6 --type Plasma/Applet -u $panel_colorizer_plasmoid
fi
...
elif [ ! -d "$HOME/.local/share/plasma/plasmoids/luisbocanegra.panelspacer.extended" ]; then
  kpackagetool6 --type Plasma/Applet -u $panelspacer_extended_plasmoid
fi
...
elif [ ! -d "$HOME/.local/share/kwin/scripts/krohnkite" ]; then
  kpackagetool6 --type KWin/Script -u krohnkite.kwinscript
fi
...
rm -rf "$HOME/.local/share/kwin/effects/kwin4_effect_geometry_change"
mkdir -p "$HOME/.local/share/kwin/effects"
mv kwin4_effect_geometry_change "$HOME/.local/share/kwin/effects/kwin4_effect_geometry_change"
