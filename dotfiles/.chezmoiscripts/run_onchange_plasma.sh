...
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-krohnkite" --key "preventMinimize" "true"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-krohnkite" --key "screenGapBetween" "5"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-krohnkite" --key "screenGapBottom" "5"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-krohnkite" --key "screenGapLeft" "5"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-krohnkite" --key "screenGapRight" "5"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-krohnkite" --key "screenGapTop" "5"
