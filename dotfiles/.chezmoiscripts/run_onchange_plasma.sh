...
kwriteconfig6 --file "$config_dir/kwinrc" --group "Effect-better-blur-dx" --key "BlurStrength" "6"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Effect-better-blur-dx" --key "NoiseStrength" "3"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Effect-better-blur-dx" --key "WindowClasses" "ghostty"
...
kwriteconfig6 --file "$config_dir/kwinrc" --group "Plugins" --key "better_blur_dxEnabled" "true"
...
kwriteconfig6 --file "$config_dir/kwinrc" --group "Plugins" --key "virtualdesktopsonlyonprimaryEnabled" "true"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-karousel" --key "gapsInnerHorizontal" "9"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-karousel" --key "gapsInnerVertical" "9"
kwriteconfig6 --file "$config_dir/kwinrc" --group "Script-karousel" --key "gapsOuterBottom" "9"
