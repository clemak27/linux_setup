...
highlight Conditional    guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight Constant       guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=174  ctermbg=NONE cterm=NONE
...
highlight Debug          guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight Define         guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight Delimiter      guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
...
highlight Directory      guifg=#71f79f guibg=NONE    guisp=NONE    gui=bold      ctermfg=71   ctermbg=NONE cterm=NONE
highlight ErrorMsg       guifg=#ff1f66 guibg=#161925 guisp=#161925 gui=NONE      ctermfg=167  ctermbg=235  cterm=NONE
highlight Float          guifg=#A1A6A8 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=248  ctermbg=NONE cterm=NONE
highlight FoldColumn     guifg=#c8c8d0 guibg=#161925 guisp=#161925 gui=NONE      ctermfg=252  ctermbg=235  cterm=NONE
highlight Folded         guifg=#cfcfcc guibg=#2c2c3b guisp=#2c2c3b gui=NONE      ctermfg=187  ctermbg=237  cterm=NONE
highlight Function       guifg=#00c1e4 guibg=NONE    guisp=NONE    gui=bold      ctermfg=60   ctermbg=NONE cterm=bold
highlight Identifier     guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight IncSearch      guifg=#c8c8d0 guibg=#6b388f guisp=#6b388f gui=bold      ctermfg=252  ctermbg=60   cterm=bold
highlight Include        guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight Keyword        guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight Label          guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight LineNr         guifg=#575566 guibg=NONE    guisp=NONE    gui=NONE      ctermfg=241  ctermbg=NONE cterm=NONE
highlight Macro          guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight MatchParen     guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=bold      ctermfg=1    ctermbg=NONE cterm=bold
highlight ModeMsg        guifg=#F9F9F9 guibg=#192224 guisp=#192224 gui=bold      ctermfg=15   ctermbg=235  cterm=bold
highlight MoreMsg        guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=bold      ctermfg=1    ctermbg=NONE cterm=bold
highlight NonText        guifg=#161925 guibg=#161925 guisp=#161925 gui=NONE      ctermfg=235  ctermbg=235  cterm=NONE
highlight Number         guifg=#6789e4 guibg=NONE    guisp=#00c1e4 gui=NONE      ctermfg=224  ctermbg=60   cterm=NONE
highlight Operator       guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=bold      ctermfg=1    ctermbg=NONE cterm=bold
highlight PMenu          guifg=#cfcfcc guibg=#2c2c3b guisp=#2c2c3b gui=NONE      ctermfg=187  ctermbg=237  cterm=NONE
highlight PMenuSbar      guifg=#e2e4e5 guibg=#161925 guisp=#161925 gui=NONE      ctermfg=254  ctermbg=238  cterm=NONE
...
highlight PreCondit      guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight PreProc        guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight Repeat         guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=bold      ctermfg=1    ctermbg=NONE cterm=bold
highlight Search         guifg=#c8c8d0 guibg=#6b388f guisp=#44597f gui=NONE      ctermfg=252  ctermbg=60   cterm=NONE
highlight Special        guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight SpecialChar    guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight SpecialComment guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight SpecialKey     guifg=#5E6C70 guibg=NONE    guisp=NONE    gui=italic    ctermfg=66   ctermbg=NONE cterm=NONE
highlight SpellBad       guifg=#ff1f66 guibg=#161925 guisp=#161925 gui=undercurl ctermfg=167  ctermbg=235  cterm=undercurl
...
highlight Statement      guifg=#c74ded guibg=NONE    guisp=NONE    gui=bold      ctermfg=179  ctermbg=NONE cterm=bold
...
highlight StorageClass   guifg=#00c1e4 guibg=NONE    guisp=NONE    gui=bold      ctermfg=60   ctermbg=NONE cterm=bold
highlight String         guifg=#71f79f guibg=NONE    guisp=NONE    gui=NONE      ctermfg=71   ctermbg=NONE cterm=NONE
highlight Structure      guifg=#00c1e4 guibg=NONE    guisp=NONE    gui=bold      ctermfg=60   ctermbg=NONE cterm=bold
highlight Tag            guifg=#f9dc5c guibg=NONE    guisp=NONE    gui=NONE      ctermfg=1    ctermbg=NONE cterm=NONE
highlight Title          guifg=#F9F9FF guibg=#192224 guisp=#192224 gui=bold      ctermfg=189  ctermbg=235  cterm=bold
highlight Todo           guifg=#c3a45b guibg=#161925 guisp=#161925 gui=NONE      ctermfg=179  ctermbg=235  cterm=NONE
highlight Type           guifg=#00c1e4 guibg=NONE    guisp=NONE    gui=bold      ctermfg=104  ctermbg=NONE cterm=bold
highlight Typedef        guifg=#00c1e4 guibg=NONE    guisp=NONE    gui=bold      ctermfg=60   ctermbg=NONE cterm=bold
...
highlight cursorim       guifg=#192224 guibg=#00c1e4 guisp=#00c1e4 gui=NONE      ctermfg=235  ctermbg=60   cterm=NONE
